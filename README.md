...
Epigen describes different models as follows. A mean phenotype
...
collapsing the matrix row-wise:
    ...
    --model mu_AABB mu_AaBB mu_aaBB mu_AABb mu_AaBb mu_aaBb mu_AAbb mu_Aabb mu_aabb
...
we pass it to the program by:
    ...
    --model 0.5 0.5 0.5 0.5 0.7 0.7 0.5 0.7 0.7
...
at some point I will add support for a subset of the regression models.
...
genotype file (plink file) by:
    ...
    epigen pheno-binary --model 0.5 0.5 0.5 0.5 0.7 0.7 0.5 0.7 0.7 --out plink.pheno plink
...
of the test. Data is generated by the following command
    ...
    epigen pair-single --model 0.5 0.5 0.5 0.5 0.7 0.7 0.5 0.7 0.7 --maf 0.3 0.3\
